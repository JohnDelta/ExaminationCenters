<%-- 
    Document   : admin-subjects-insert
    Created on : 12 Σεπ 2018, 5:27:41 μμ
    Author     : Ιωάννης Δεληγιάννης 151102
--%>
...
if(!user.equals("admin")){
    ...
    /*      READ EXCEL FILE IN FORM - ID_SUBJECT,TITLE,DESCRIPTION (IN THIS ORDER)  
            AND INSERT THE SUBJECT TO THE DB
            ...
            try {
                ...
                while (iter.hasNext()) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        connection.close();
                        out.print("<script>window.location.replace('admin-subjects.jsp');</script>");
                    }
                }
