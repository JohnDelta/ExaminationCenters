...
<%
    ...
    if(request.getParameter("insert")!=null){
        ...
        if(id_user!=null){
            ...
            if(alreadyIn>0){
                //user already in
                out.print("<script>alert('Ο χρήστης είναι ήδη εγγεγραμμένος στο εξεταστικό κέντρο');</script>");
            }
            else{
                //insert user
                ...
                out.print("<script>alert('Η εισαγωγή ολοκληρώθηκε');</script>");
            }
        }else{
...
<html>
    <head>
        <title>ΕΠΓ - Εισαγωγή σε Κέντρο</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="context">
            ...
            <h4>Εισαγωγή Εξεταζόμενων στο Εξεταστικό Κέντρο</h4>
            <hr>
            ...
            <div class="format-forms">
                <form name="formInsert" method="POST" action="supervisor-class-insert.jsp"
                      onsubmit="return validateStudentInsertForm()">
                    ...
                    <p>Εξεταστικό κέντρο</p>
                    <select name="class" size='1'>
                        <option value='<%=id_class%>'><%=className%> | <%=id_class%></option>
                    </select>
                    <input type="submit" value="Εισαγωγή" name="insert">
            ...
            <div class="format-forms" style="float:right;">
                ...
                <h4>Μορφή : Όνομα λογαριασμού | Όνομα | Επώνυμο</h4>
                <h5>Η πρώτη γραμμή του αρχείου είναι για τους τίτλους και παραλείπεται</h5>
                <form method="POST" action="supervisor-class-insert-excel.jsp" onsubmit="return validateFileForm()" enctype = "multipart/form-data">
        ...
        <script>
            ...
            function validateStudentInsertForm(){
