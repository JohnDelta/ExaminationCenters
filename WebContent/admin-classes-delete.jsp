...
if(!user.equals("admin")){
    ...
    /*      READ EXCEL FILE IN FORM - ID_CLASS,NAME,ADDRESS,ID_EXAMINATION (IN THIS ORDER)  
            AND INSERT THE CLASS TO THE DB
            ...
            try {
                ...
                while (iter.hasNext()) {
                    ...
                    if (!item.isFormField()) {
                                ...
                                if(row.getLastCellNum()>=1 && row.getRowNum()>0){
                                    ...
                                    if(flag){
                                        ...
                                        if(flag){
                                            ...
                                            //cannot delete class, users are still assigned to it
                                        }
                                    }else{
                        ...
                        connection.close();
                        out.print("<script>window.location.replace('admin-classes.jsp');</script>");
                    }
                }
