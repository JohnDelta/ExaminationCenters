...
if(!user.equals("admin")){
    ...
    /*      READ EXCEL FILE IN FORM - ID_QUESTION,QUESTION,ASNWER1,ANSWER2,ANSWER3,ANSWER4,CORRECT,ID_SUBJECT (IN THIS ORDER)  
            AND INSERT THE QUESTION TO THE DB
            ...
            try {
                ...
                while (iter.hasNext()) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        connection.close();
                        out.print("<script>window.location.replace('admin-questions.jsp');</script>");
                    }
                }
